...
## Build Instructions
This project is developed using C# with WinForms targeting the .NET Framework 4.5.2. To build the project successfully in Visual Studio 2024, follow these steps:
...
## Now Up To Date
We the Team of Any0ne have now added the newest Versions of every game!
